    ...
    <div>
      <div className="">
        ...
        <h1 className='text-lg font-bold text-primary mb-5'>
          This section allows you to Extract questions based on the text you previously extracted from the PDF.
        </h1>
        <div className="flex flex-col space-y-4">
          ...
          >
            {!extractQuestion.isPending ? 'Extract Questions' : <Spinner spin={true} property={''}/>}
          </Button>
          ...
          )}
          {
            questions.length === 0 && extractQuestion.isSuccess && (
              <p className='text-primary'>No questions Extracted. Try increasing the text size.</p>)
          }
          {
            questions.length === 0 && extractQuestion.isError && (
              <p className='text-red-600'>Failed to Extract questions. Please try again.</p>)
          }
          {
            questions.length > 0 && (
