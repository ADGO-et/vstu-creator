    ...
    >
      ...
      <div className="relative z-10 w-full max-w-lg flex flex-col items-center">
        <div className="bg-white/50 p-10 rounded-3xl shadow-2xl w-full flex flex-col items-center border border-slate-200 backdrop-blur-md animate-fade-in">
          ...
          <div className="w-full flex justify-between items-center mb-6 gap-4">
            ...
            <img
              src={signin}
              alt="VSTU Logo"
              className="w-auto max-w-[4rem] object-contain"
            />
          </div>
          <h1 className="text-2xl font-bold text-slate-800 mb-2 tracking-tight">
            Welcome Back
          </h1>
          <p className="text-slate-800 mb-6 text-center text-sm">
          ...
          <Tabs
            ...
            className="w-full"
            onValueChange={(val) => {
              if (val === "creator" || val === "teacher" || val === "sales")
                setRole(val);
            }}
          >
        ...
        <div className="mt-8 text-xs text-slate-400 text-center w-full animate-fade-in delay-200">
          &copy; {new Date().getFullYear()} VSTU Administrator Portal. All
          rights reserved.
        </div>
      </div>
    </main>
    ...
    <Form {...form}>
      ...
      >
        ...
        <Button
          ...
          type="submit"
          className={`w-full py-3 rounded-lg font-semibold text-base hover:from-blue-600 hover:to-sky-500 text-white shadow-lg transition-all duration-200 flex items-center justify-center gap-2 ${
            role === "creator"
        ...
        <div className="w-full flex justify-center items-center">
          <Link to="/signup">
            <span className="text-md hover:underline text-center text-blue-950">
              Signup
            </span>
          </Link>
        </div>
